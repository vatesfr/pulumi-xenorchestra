...
export function getHost(args: GetHostArgs, opts?: pulumi.InvokeOptions): Promise<GetHostResult> {
    pulumi.log.warn("getHost is deprecated: xenorchestra.index/gethost.getHost has been deprecated in favor of xenorchestra.index/getxoahost.getXoaHost")
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("xenorchestra:index/getHost:getHost", {
...
export function getHostOutput(args: GetHostOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHostResult> {
    pulumi.log.warn("getHost is deprecated: xenorchestra.index/gethost.getHost has been deprecated in favor of xenorchestra.index/getxoahost.getXoaHost")
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("xenorchestra:index/getHost:getHost", {
        "nameLabel": args.nameLabel,
        "tags": args.tags,
    }, opts);
}
