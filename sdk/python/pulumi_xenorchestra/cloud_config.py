...
class CloudConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] template: The cloud init config. See the cloud init docs for more [information](https://cloudinit.readthedocs.io/en/latest/topics/examples.html).
        :param pulumi.Input[builtins.str] name: The name of the cloud config.
        """
...
class CloudConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            template: Optional[pulumi.Input[builtins.str]] = None) -> 'CloudConfig':
        """
