...
def get_xoa_network(bridge: Optional[builtins.str] = None,
    ...
    :param builtins.str bridge: The name of the bridge network interface.
    :param builtins.str name_label: The name of the network.
    :param builtins.str pool_id: The pool the network is associated with.
    """
    __args__ = dict()
...
def get_xoa_network_output(bridge: Optional[pulumi.Input[Optional[builtins.str]]] = None,
