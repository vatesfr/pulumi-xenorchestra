...
class XoaNetworkArgs:
    def __init__(__self__, *,
                 ...
                 nbd: Optional[pulumi.Input[builtins.bool]] = None,
                 source_pif_device: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] nbd: Whether the network should use a network block device. Defaults to `false` if unspecified.
        :param pulumi.Input[builtins.str] source_pif_device: The PIF device (eth0, eth1, etc) that will be used as an input during network creation. This parameter is required if a vlan is specified.
        :param pulumi.Input[builtins.int] vlan: The vlan to use for the network. Defaults to `0` meaning no VLAN.
        """
    ...
    @property
    @pulumi.getter
    def nbd(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @nbd.setter
    def nbd(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "nbd", value)

    @property
    @pulumi.getter(name="sourcePifDevice")
    def source_pif_device(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_pif_device(self, value: Optional[pulumi.Input[builtins.str]]):
...
class XoaNetwork(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pool_id: Optional[pulumi.Input[builtins.str]] = None,
            source_pif_device: Optional[pulumi.Input[builtins.str]] = None,
            vlan: Optional[pulumi.Input[builtins.int]] = None) -> 'XoaNetwork':
        """
    ...
    @property
    @pulumi.getter
    def nbd(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the network should use a network block device. Defaults to `false` if unspecified.
        """
        return pulumi.get(self, "nbd")
    ...
    @property
    @pulumi.getter(name="sourcePifDevice")
    def source_pif_device(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The PIF device (eth0, eth1, etc) that will be used as an input during network creation. This parameter is required if a vlan is specified.
        """
        return pulumi.get(self, "source_pif_device")
