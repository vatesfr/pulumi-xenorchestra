...
class GetXoaVdiResult:
    ...
    def name_label(self) -> Optional[builtins.str]:
        """
...
def get_xoa_vdi(id: Optional[builtins.str] = None,
                name_label: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the VDI.
    :param builtins.str name_label: The name of the VDI to look up.
    :param builtins.str pool_id: The ID of the pool the VDI belongs to. This is useful if you have a VDI with the same name on different pools.
...
def get_xoa_vdi_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       name_label: Optional[pulumi.Input[Optional[builtins.str]]] = None,
