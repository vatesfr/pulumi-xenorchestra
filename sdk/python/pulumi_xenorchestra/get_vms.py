...
warnings.warn("""xenorchestra.index/getvms.getVms has been deprecated in favor of xenorchestra.index/getxoavms.getXoaVms""", DeprecationWarning)
...
def get_vms(host: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vms is deprecated: xenorchestra.index/getvms.getVms has been deprecated in favor of xenorchestra.index/getxoavms.getXoaVms""")
    __args__ = dict()
    __args__['host'] = host
...
def get_vms_output(host: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('xenorchestra:index/getVms:getVms', __args__, opts=opts, typ=GetVmsResult)
