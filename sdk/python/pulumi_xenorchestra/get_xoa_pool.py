...
class GetXoaPoolResult:
    ...
    @property
    @pulumi.getter
    def cpus(self) -> Mapping[str, builtins.str]:
        """
...
def get_xoa_pool(name_label: Optional[builtins.str] = None,
    ...
    :param builtins.str name_label: The name_label of the pool to look up.
    """
    __args__ = dict()
...
def get_xoa_pool_output(name_label: Optional[pulumi.Input[builtins.str]] = None,
