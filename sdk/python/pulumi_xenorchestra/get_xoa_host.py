...
class GetXoaHostResult:
    ...
    def memory_usage(self) -> builtins.float:
        """
...
def get_xoa_host(name_label: Optional[builtins.str] = None,
...
def get_xoa_host_output(name_label: Optional[pulumi.Input[builtins.str]] = None,
