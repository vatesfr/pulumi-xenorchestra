...
class ResourceSetLimit(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param _builtins.int quantity: The numerical limit for the given type.
        :param _builtins.str type: The type of resource set limit. Must be cpus, memory or disk.
        """
...
class VmCdrom(dict):
    def __init__(__self__, *,
                 id: _builtins.str):
        """
        :param _builtins.str id: The ID of the ISO (VDI) to attach to the VM. This can be easily provided by using the `vdi` data source.
        """
...
class VmDisk(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vbd_id: Optional[_builtins.str] = None,
                 vdi_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str name_label: The name for the disk
        :param _builtins.float size: The size in bytes for the disk.
        :param _builtins.str sr_id: The storage repository ID to use.
        :param _builtins.bool attached: Whether the device should be attached to the VM.
        :param _builtins.str name_description: The description for the disk
        :param _builtins.str position: Indicates the order of the block device.
        """
    ...
    def name_description(self) -> Optional[_builtins.str]:
        """
    ...
    def vbd_id(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "vbd_id")

    @_builtins.property
    @pulumi.getter(name="vdiId")
    def vdi_id(self) -> Optional[_builtins.str]:
...
class VmNetwork(dict):
    ...
    def expected_ip_cidr(self) -> Optional[_builtins.str]:
        """
        Determines the IP CIDR range the provider will wait for on this network interface. Resource creation is not complete until an IP address within the specified range becomes available. This parameter replaces the former `wait_for_ip` functionality. This only works if guest-tools are installed in the VM. Defaults to "", which skips IP address matching.
        """
...
class GetXoaHostsHostResult(dict):
    def __init__(__self__, *,
                 cpus: Mapping[str, _builtins.int],
                 id: _builtins.str,
...
class GetXoaVmsVmResult(dict):
    def __init__(__self__, *,
                 ...
                 blocked_operations: Optional[Sequence[_builtins.str]] = None,
                 clone_type: Optional[_builtins.str] = None,
                 cloud_config: Optional[_builtins.str] = None,
                 cloud_network_config: Optional[_builtins.str] = None,
                 core_os: Optional[_builtins.bool] = None,
                 cpu_cap: Optional[_builtins.int] = None,
                 cpu_weight: Optional[_builtins.int] = None,
                 exp_nested_hvm: Optional[_builtins.bool] = None,
                 high_availability: Optional[_builtins.str] = None,
                 host: Optional[_builtins.str] = None,
                 hvm_boot_firmware: Optional[_builtins.str] = None,
                 name_description: Optional[_builtins.str] = None,
        ...
        :param Sequence[_builtins.str] blocked_operations: List of operations on a VM that are not permitted. Examples include: clean_reboot, clean_shutdown, hard_reboot, hard_shutdown, pause, shutdown, suspend, destroy. See: https://xapi-project.github.io/xen-api/classes/vm.html#enum_vm_operations
    ...
    def memory_max(self) -> _builtins.int:
        """
    ...
    def memory_min(self) -> _builtins.int:
        """
    ...
    def affinity_host(self) -> Optional[_builtins.str]:
        """
    ...
    def auto_poweron(self) -> Optional[_builtins.bool]:
        """
    ...
    def blocked_operations(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def cloud_network_config(self) -> Optional[_builtins.str]:
        """
    ...
    def core_os(self) -> Optional[_builtins.bool]:
    ...
    def exp_nested_hvm(self) -> Optional[_builtins.bool]:
        """
    ...
    def hvm_boot_firmware(self) -> Optional[_builtins.str]:
        """
    ...
    def resource_set(self) -> Optional[_builtins.str]:
    ...
    @_builtins.property
    @pulumi.getter
    def vga(self) -> Optional[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def xenstore(self) -> Optional[Mapping[str, _builtins.str]]:
        """
...
class GetXoaVmsVmDiskResult(dict):
    def __init__(__self__, *,
                 ...
                 size: _builtins.int,
                 sr_id: _builtins.str,
                 vbd_id: _builtins.str,
                 vdi_id: _builtins.str,
                 attached: Optional[_builtins.bool] = None,
                 name_description: Optional[_builtins.str] = None):
        """
        :param _builtins.str name_label: The name for the disk
        :param _builtins.str position: Indicates the order of the block device.
        :param _builtins.int size: The size in bytes for the disk.
        :param _builtins.str sr_id: The storage repository ID to use.
        :param _builtins.bool attached: Whether the device should be attached to the VM.
        :param _builtins.str name_description: The description for the disk
        """
    ...
    @_builtins.property
    @pulumi.getter(name="vbdId")
    def vbd_id(self) -> _builtins.str:
        return pulumi.get(self, "vbd_id")

    @_builtins.property
    @pulumi.getter(name="vdiId")
    def vdi_id(self) -> _builtins.str:
        return pulumi.get(self, "vdi_id")
