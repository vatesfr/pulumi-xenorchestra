...
class XoaBondedNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] pif_ids: The PIFs (uuid) that should be used for this network.
        """
...
class XoaBondedNetwork(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="pifIds")
    def pif_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        The PIFs (uuid) that should be used for this network.
        """
        return pulumi.get(self, "pif_ids")
