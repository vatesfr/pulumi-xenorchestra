...
class ResourceSetLimitArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.int] quantity: The numerical limit for the given type.
        :param pulumi.Input[_builtins.str] type: The type of resource set limit. Must be cpus, memory or disk.
        """
...
class VmCdromArgs:
    def __init__(__self__, *,
                 id: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] id: The ID of the ISO (VDI) to attach to the VM. This can be easily provided by using the `vdi` data source.
        """
...
class VmDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] sr_id: The storage repository ID to use.
        :param pulumi.Input[_builtins.bool] attached: Whether the device should be attached to the VM.
        :param pulumi.Input[_builtins.str] name_description: The description for the disk
        :param pulumi.Input[_builtins.str] position: Indicates the order of the block device.
        """
