...
def get_xoa_template(name_label: Optional[builtins.str] = None,
    ...
    :param builtins.str name_label: The name of the template to look up.
    :param builtins.str pool_id: The id of the pool that the template belongs to.
    """
    __args__ = dict()
...
def get_xoa_template_output(name_label: Optional[pulumi.Input[builtins.str]] = None,
