...
warnings.warn("""xenorchestra.index/getuser.getUser has been deprecated in favor of xenorchestra.index/getxoauser.getXoaUser""", DeprecationWarning)
...
def get_user(search_in_session: Optional[bool] = None,
    ...
    :param bool search_in_session: A boolean which will search for the user in the current session (`session.getUser` Xen Orchestra RPC call). This allows a non admin user to look up their own user account.
    :param str username: The username of the XO user.
    """
    pulumi.log.warn("""get_user is deprecated: xenorchestra.index/getuser.getUser has been deprecated in favor of xenorchestra.index/getxoauser.getXoaUser""")
    __args__ = dict()
...
def get_user_output(search_in_session: Optional[pulumi.Input[Optional[bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('xenorchestra:index/getUser:getUser', __args__, opts=opts, typ=GetUserResult)
