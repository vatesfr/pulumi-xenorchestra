...
warnings.warn("""xenorchestra.index/gethost.getHost has been deprecated in favor of xenorchestra.index/getxoahost.getXoaHost""", DeprecationWarning)
...
def get_host(name_label: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_host is deprecated: xenorchestra.index/gethost.getHost has been deprecated in favor of xenorchestra.index/getxoahost.getXoaHost""")
    __args__ = dict()
...
def get_host_output(name_label: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('xenorchestra:index/getHost:getHost', __args__, opts=opts, typ=GetHostResult)
