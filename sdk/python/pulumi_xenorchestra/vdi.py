...
class VdiArgs:
    def __init__(__self__, *,
                 filepath: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] filepath: The file path to the ISO or vdi image that should be uploaded when the VDI is created.
        :param pulumi.Input[builtins.str] name_label: The name label of the VDI
        :param pulumi.Input[builtins.str] sr_id: The id of the storage repository the VDI should be created in. Make sure the storage repository supports the file you are uploading! For example, ISOs should only be uploaded to ISO storage repositories.
        :param pulumi.Input[builtins.str] type: Only `raw` uploads are supported today, but vhd support may be added in the future.
        """
    ...
    @property
    @pulumi.getter
    def filepath(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @filepath.setter
    def filepath(self, value: pulumi.Input[builtins.str]):
...
class _VdiState:
    def __init__(__self__, *,
                 filepath: Optional[pulumi.Input[builtins.str]] = None,
                 name_label: Optional[pulumi.Input[builtins.str]] = None,
                 sr_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def filepath(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The file path to the ISO or vdi image that should be uploaded when the VDI is created.
        """
        return pulumi.get(self, "filepath")
    ...
    @filepath.setter
    def filepath(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "filepath", value)
    ...
    @property
    @pulumi.getter(name="srId")
    def sr_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The id of the storage repository the VDI should be created in. Make sure the storage repository supports the file you are uploading! For example, ISOs should only be uploaded to ISO storage repositories.
        """
        return pulumi.get(self, "sr_id")
    ...
    @sr_id.setter
    def sr_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sr_id", value)
...
class Vdi(pulumi.CustomResource):
    ...
    pulumi_type = "xenorchestra:index/vdi:Vdi"
    ...
    def get(resource_name: str,
            ...
            name_label: Optional[pulumi.Input[builtins.str]] = None,
            sr_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'Vdi':
        """
    ...
    @property
    @pulumi.getter
    def filepath(self) -> pulumi.Output[builtins.str]:
        """
        The file path to the ISO or vdi image that should be uploaded when the VDI is created.
        """
        return pulumi.get(self, "filepath")
    ...
    @property
    @pulumi.getter(name="srId")
    def sr_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the storage repository the VDI should be created in. Make sure the storage repository supports the file you are uploading! For example, ISOs should only be uploaded to ISO storage repositories.
        """
        return pulumi.get(self, "sr_id")
