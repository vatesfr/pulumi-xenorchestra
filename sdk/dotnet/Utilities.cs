...
namespace Pulumi.Xenorchestra
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/vatesfr/pulumi-xenorchestra";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Xenorchestra.version.txt");
    ...
    internal sealed class XenorchestraResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public XenorchestraResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
