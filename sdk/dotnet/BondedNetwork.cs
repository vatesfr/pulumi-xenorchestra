...
namespace Pulumi.Xenorchestra
{
    ...
    /// ```
    /// </summary>
    [Obsolete(@"xenorchestra.index/bondednetwork.BondedNetwork has been deprecated in favor of xenorchestra.index/xoabondednetwork.XoaBondedNetwork")]
    [XenorchestraResourceType("xenorchestra:index/bondedNetwork:BondedNetwork")]
    public partial class BondedNetwork : global::Pulumi.CustomResource
    {
        [Output("automatic")]
        ...
        public BondedNetwork(string name, BondedNetworkArgs args, CustomResourceOptions? options = null)
            : base("xenorchestra:index/bondedNetwork:BondedNetwork", name, args ?? new BondedNetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BondedNetwork(string name, Input<string> id, BondedNetworkState? state = null, CustomResourceOptions? options = null)
            : base("xenorchestra:index/bondedNetwork:BondedNetwork", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BondedNetwork Get(string name, Input<string> id, BondedNetworkState? state = null, CustomResourceOptions? options = null)
        {
            return new BondedNetwork(name, id, state, options);
        }
    }

    public sealed class BondedNetworkArgs : global::Pulumi.ResourceArgs
    {
        [Input("automatic")]
        ...
        public BondedNetworkArgs()
        {
        }
        public static new BondedNetworkArgs Empty => new BondedNetworkArgs();
    }

    public sealed class BondedNetworkState : global::Pulumi.ResourceArgs
    {
        [Input("automatic")]
        public Input<bool>? Automatic { get; set; }
        ...
        public BondedNetworkState()
        {
        }
        public static new BondedNetworkState Empty => new BondedNetworkState();
    }
}
