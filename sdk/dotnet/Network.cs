...
namespace Pulumi.Xenorchestra
{
    ...
    /// ```
    /// </summary>
    [Obsolete(@"xenorchestra.index/network.Network has been deprecated in favor of xenorchestra.index/xoanetwork.XoaNetwork")]
    [XenorchestraResourceType("xenorchestra:index/network:Network")]
    public partial class Network : global::Pulumi.CustomResource
    {
        ...
        public Network(string name, NetworkArgs args, CustomResourceOptions? options = null)
            : base("xenorchestra:index/network:Network", name, args ?? new NetworkArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Network(string name, Input<string> id, NetworkState? state = null, CustomResourceOptions? options = null)
            : base("xenorchestra:index/network:Network", name, state, MakeResourceOptions(options, id))
        {
        }
