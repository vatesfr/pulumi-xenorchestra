...
{
    [Obsolete(@"xenorchestra.index/gethost.getHost has been deprecated in favor of xenorchestra.index/getxoahost.getXoaHost")]
    public static class GetHost
    {
        ...
        public static Task<GetHostResult> InvokeAsync(GetHostArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHostResult>("xenorchestra:index/getHost:getHost", args ?? new GetHostArgs(), options.WithDefaults());
        ...
        public static Output<GetHostResult> Invoke(GetHostInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHostResult>("xenorchestra:index/getHost:getHost", args ?? new GetHostInvokeArgs(), options.WithDefaults());
